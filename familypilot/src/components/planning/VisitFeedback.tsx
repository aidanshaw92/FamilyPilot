...
export function VisitFeedbackForm({venueId,date,onDone,onCancel}:{venueId:string;date:string;onDone:(id:string)=>void;onCancel:()=>void}) {
 ...
 return <Card style={s.panel}><Text variant="heading3">What did you find?</Text><Text variant="bodySmall">Only report what you checked on {date}. We share a summary of observations, never your name, family details or routines.</Text>
...
export function PostVisitInbox(){
 ...
 return <Card style={s.panel}><Text variant="heading3">Did you visit {due.plan.name}?</Text><Text>{due.date} · A couple of quick checks can help the next family.</Text>
