...
const facts:MatchableVenueFacts={placeId:'test',name:'Test venue',category:'park',driveMinutes:20,enrichmentStatus:'verified',minRecommendedAge:0,maxRecommendedAge:10,minAdmissionAge:null,maxAdmissionAge:null,toilets:'yes',babyChanging:'yes',parking:'yes',pushchairSuitability:'good',environment:'outdoor',energyLevel:'moderate',visitDurationMinutes:60,estimatedSpend:'Free',goodToKnow:[],warnings:[],openingStatus:'unknown'};
